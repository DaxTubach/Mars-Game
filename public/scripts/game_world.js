function populateWorld(){
	...
	spriteArray.push(
		new PIXI.Sprite(PIXI.loader.resources["images/astronaut.png"].texture)
	);

	spriteArray.push(
		new PIXI.Sprite(PIXI.loader.resources["images/rover.png"].texture)
	);
	...
	spriteArray.push(
		new PIXI.Sprite(PIXI.loader.resources["images/water-tank.png"].texture)
	);
